...
class CoffeeDataset:
    ...
    def __init__(
        self, year_to_coffee_time_series: Dict[str, pd.DataFrame]
    ) -> None:
        self._coffee_time_series = year_to_coffee_time_series
        self._years = sorted(
            list(year_to_coffee_time_series.keys())
        )
    ...
    def __getitem__(self, year: int) -> pd.DataFrame:
        ...
        return self._coffee_time_series[year_str]
    ...
    def from_kaggle(
        ...
        data = cls(year_to_coffee_time_series=year_to_df)
